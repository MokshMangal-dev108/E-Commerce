package com.moksh.ecommerce.model;
...
public class User {
	...
	@Embedded //this is used when we don't want to make another table but still want 
		//to implement in different class because code simplification and better encapsulation
	@ElementCollection
