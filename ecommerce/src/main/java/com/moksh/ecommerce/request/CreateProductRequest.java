package com.moksh.ecommerce.request;

import java.util.HashSet;
import java.util.Set;

import com.moksh.ecommerce.model.Size;
...
public class CreateProductRequest {
	...
	//category like if it is a shirt then for top level men, second level clothes, third
	// level some branding
